...
(function controlLanguage() {
	...
	function ruTranslator() {
		$('.color-theme-wrapper > label > div').classList.add('switch-desk-ru')
		$('.color-theme-wrapper > label > div').innerText = 'Цветная тема'
	...
	function enTranslator() {
		$('.color-theme-wrapper > label > div').innerText = 'Color theme'
		$('.color-theme-wrapper > label > div').classList.remove('switch-desk-ru')
