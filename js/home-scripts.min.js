...
function ruTranslator() {
	...
	document.querySelector('.portfolio > div:nth-child(2) > div > div > div > h3').innerText = 'Закончил несколько курсов по React.js и решил решил закрепить свои знания и сделал интернет магазин на Реакте.'
