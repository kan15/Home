...
function flick(select) {
	...
	let fli = setInterval(function () {
		...
		} else elem.innerHTML = startElem;
		i++;
	}, 550);
}

window.onload = function () {
	if (language == 'en') startEnglishAppearFont();
	if (language == 'ru') {
		startRussianAppearFont();
	}
}
...
function ruTranslator() {
	...
	document.querySelector('.switch-desk').innerText = 'Russian';
	document.querySelector('.first-desc').innerText = 'Здесь собраны разные фичи и программы, которые я делал. Все сделано на нативном Javascript без использования jQuery или других библиотек.';

	document.querySelector('section.tetris-section .definition > div.h2').innerText = 'Тетрис';
	document.querySelector('.tetris-section .definition > div.desc').innerText = `Классический Тетрис. Выберите уровень сложности и игра начнётся. Управление на WASD или стрелками.`;
	document.querySelector('.tetris-section > div > div > div.col-md-5.definition > div.complication > button.btn-compl.draw-border.easy').innerText = 'Легкий'
	document.querySelector('.tetris-section > div > div > div.col-md-5.definition > div.complication > button.btn-compl.draw-border.normal').innerText = 'Средний'
	document.querySelector('.tetris-section > div > div > div.col-md-5.definition > div.complication > button.btn-compl.draw-border.hard').innerText = 'Тяжёлый'

	document.querySelector('.calculator-section > div > div > div.col-md-5 > div.h2').innerText = 'Калькулятор'
	document.querySelector('.calculator-section > div > div > div.col-md-5 > div.desc').innerText = 'Калькулятор как на IOS.'

	document.querySelector('section.snake-section div.h2').innerText = 'Змейка'
	document.querySelector('section.snake-section div.desc').innerText = 'Выберите уровень сложности и игра начнётся.'
	document.querySelector('.snake-section > div > div > div.col-md-5.anime-dis.definition > div.complication > button.btn-compl-snake.draw-border.easy').innerText = 'Легкий'
	document.querySelector('.snake-section > div > div > div.col-md-5.anime-dis.definition > div.complication > button.btn-compl-snake.draw-border.normal').innerText = 'Средний'
	document.querySelector('.snake-section > div > div > div.col-md-5.anime-dis.definition > div.complication > button.btn-compl-snake.draw-border.hard').innerText = 'Тяжелый'

	document.querySelector('.cloth-section .h2').innerText = 'Симулятор ткани';
	document.querySelector('.cloth-section .desc').innerText = 'Левая кнопка мыши, чтобы потянуть ткань, правая чтобы порвать.';
	document.querySelector('.cloth-section div.complication button').innerText = 'Заново'

	document.querySelector('.google-interview-section h2').innerText = 'Задача с Google собеседования'
	document.querySelector('.google-interview-section > div > div > div.col-md-6 > div').innerHTML = `Решил задачу с <a href="https://www.youtube.com/watch?v=10WnvBk9sZc&t=2792s" target="_blank">Google
...
потратил кучу часов и все таки сделал правильно.`
	document.querySelector('.google-task-en').classList.add('google-task-ru');
	document.querySelector('.google-interview-section > div > div > div.col-md-5.offset-md-1 > div > div:nth-child(1)').innerText = 'Первая строка:'
	document.querySelector('.google-interview-section > div > div > div.col-md-5.offset-md-1 > div > div:nth-child(3)').innerText = 'Вторая строка:'
	document.querySelector('.google-interview-section > div > div > div.col-md-5.offset-md-1 > div > button').innerText = 'Получить ответ';

	document.querySelector('.lightning-section > div > div > div > h2').innerText = 'Эффект электрозаряда';

	document.querySelector('.decoder-section > div > div:nth-child(1) > div > h2').innerText = 'Шифратор сообщений'
	document.querySelector('.decoder-section > div > div:nth-child(1) > div > div').innerText = 'Вам нужно ввести любой текст в первый инпут и скрипт выдаст вам определённую последовательность цифр. Не думаю, что этот шифр можно разгадать, потому что на каждую букву несколько вариантов последовательности и разная длина.'
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper > h3').innerText = 'Ввод'
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-6.encoder-input-wrapper > h3').innerText = 'Шифр'
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper > h3.decoder-title').innerText = 'Дешифратор';
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper > div > button').innerText = 'Получить шифр'
	document.querySelector('body > section.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper.anime-right > div > button').innerText = 'Расшифровать'

	document.querySelector('.end-desc').innerText = 'Спасибо за просмотр'
}
...
function en() {
	...
	document.querySelector('.switch-desk').innerText = 'English';
	document.querySelector('.first-desc').innerText = 'Here are collected various features and programs that I did. Everything is done on the native Javascript without using jQuery or other libraries.';

	document.querySelector('section.tetris-section .definition > div.h2').innerText = 'Tetris';
	document.querySelector('.tetris-section .definition > div.desc').innerText = `Classic Tetris. Choose the difficulty level and the game will begin. Control on WASD or arrows.`;
	document.querySelector('.tetris-section > div > div > div.col-md-5.definition > div.complication > button.btn-compl.draw-border.easy').innerText = 'Easy'
	document.querySelector('.tetris-section > div > div > div.col-md-5.definition > div.complication > button.btn-compl.draw-border.normal').innerText = 'Medium'
	document.querySelector('.tetris-section > div > div > div.col-md-5.definition > div.complication > button.btn-compl.draw-border.hard').innerText = 'Hard'

	document.querySelector('.calculator-section > div > div > div.col-md-5 > div.h2').innerText = 'Calculator'
	document.querySelector('.calculator-section > div > div > div.col-md-5 > div.desc').innerText = 'Calculator like on iOS.'

	document.querySelector('section.snake-section div.h2').innerText = 'Snake'
	document.querySelector('section.snake-section div.desc').innerText = 'Choose the difficulty level and the game will begin.'
	document.querySelector('.snake-section > div > div > div.col-md-5.anime-dis.definition > div.complication > button.btn-compl-snake.draw-border.easy').innerText = 'Easy'
	document.querySelector('.snake-section > div > div > div.col-md-5.anime-dis.definition > div.complication > button.btn-compl-snake.draw-border.normal').innerText = 'Medium'
	document.querySelector('.snake-section > div > div > div.col-md-5.anime-dis.definition > div.complication > button.btn-compl-snake.draw-border.hard').innerText = 'Hard'

	document.querySelector('.cloth-section .h2').innerText = 'Simulation of cloth';
	document.querySelector('.cloth-section .desc').innerText = 'Left mouse button to pull cloth, right mouse button to tear.';
	document.querySelector('.cloth-section div.complication button').innerText = 'Repeat';

	document.querySelector('.google-interview-section h2').innerText = 'Task from Google interview'
	document.querySelector('.google-interview-section > div > div > div.col-md-6 > div').innerHTML = `Solved the task from <a href="https://www.youtube.com/watch?v=10WnvBk9sZc&t=2792s" target="_blank"> Google
	...
	document.querySelector('.google-task-en').classList.remove('google-task-ru');
	document.querySelector('.google-interview-section > div > div > div.col-md-5.offset-md-1 > div > div:nth-child(1)').innerText = 'First string'
	document.querySelector('.google-interview-section > div > div > div.col-md-5.offset-md-1 > div > div:nth-child(3)').innerText = 'Second string'
	document.querySelector('.google-interview-section > div > div > div.col-md-5.offset-md-1 > div > button').innerText = 'Get answer';

	document.querySelector('.lightning-section > div > div > div > h2').innerText = 'Lightning';

	document.querySelector('.decoder-section > div > div:nth-child(1) > div > h2').innerText = 'Message encoder'
	document.querySelector('.decoder-section > div > div:nth-child(1) > div > div').innerText = 'You need to enter any text in the first input and the script will give you a certain sequence of numbers. I do not think that this cipher can be solved, because for each letter there are several variants of the sequence and different lengths.'
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper > h3').innerText = 'Input'
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-6.encoder-input-wrapper > h3').innerText = 'Cipher'
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper > h3.decoder-title').innerText = 'Decoder';
	document.querySelector('.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper > div > button').innerText = 'Get cipher'
	document.querySelector('body > section.decoder-section > div > div:nth-child(2) > div.col-md-3.encoder-input-wrapper.anime-right > div > button').innerText = 'Decode'

	document.querySelector('.end-desc').innerText = 'Thanks for watching'
}

document.querySelector('.switch-wrapper').onclick = () => {
	lang++
	if (lang % 2 == 0) {
		if (language == 'ru') {
			en();
...
function selectOnRussianTitle() {
	setTimeout(() => {
		document.querySelector('.hello').innerText = 'Добро пожаловать';
		document.querySelector('.workshop').innerText = 'В мою библиотеку';
	}, 80);
}

function selectOnEnglishTitle() {
	setTimeout(() => {
		document.querySelector('.hello').innerText = 'Welcome To My Library';
		document.querySelector('.workshop').innerText = '';
	}, 80);
